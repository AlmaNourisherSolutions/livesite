...
public class ManageSchool {
	...
	public ManageSchool(int schoolId, String schoolName, String schoolLogo, String landlineNumber, String mobileNumber,
			String schoolAddress, String schoolEmail, String schoolContactPerson, String schoolCity, String schoolState,
			String schoolCountry, String schoolPostalCode, Date insertedDate, Date updatedDate, boolean schoolActive) {
	...
	public boolean isSchoolActive() {
		return this.schoolActive;
	}

	public void setSchoolActive(boolean schoolActive) {
